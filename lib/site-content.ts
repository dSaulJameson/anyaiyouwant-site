export const capabilities = [
  {
    ...
    short: "Websites, digital experiences, full-stack products, and internal systems designed for real operations and long-term ownership.",
    bullets: ["Website design and development", "Web, mobile, SaaS, and customer products", "Internal platforms, APIs, integrations, and cloud infrastructure"],
    ...
    outcomes: ["Launch or redesign a website, customer product, or internal platform", "Replace spreadsheets and disconnected tools", "Add a production-ready feature your team cannot schedule", "Take ownership of a platform that needs a technical reset"],
...
export const caseStudies = [
  {
    ...
    title: "Restaurant, bar, and nightclub platform",
    summary: "A connected customer and operations platform for reservations, events, payments, staffing, onboarding, training, availability, and venue management.",
  ...
  },
  {
    ...
    title: "Local discovery website and publishing engine",
    summary: "A custom-designed, data-backed website that turns live community information into useful, crawlable city and event resources.",
    ...
    capabilities: ["Web design", "Full-stack web", "Postgres", "Programmatic publishing", "Technical SEO", "Structured data"],
    metrics: ["Live event data", "Multi-city architecture", "Automated freshness"],
  },
  {
    slug: "editorial-intelligence-system",
    category: "Product engineering / Growth systems",
    title: "Market intelligence and editorial system",
    summary: "A national data and publishing platform that turns verified market signals into reviewed articles, branded creative, and channel-specific social content.",
    challenge: "A growing industry publication needed a dependable way to monitor fragmented public data, identify worthwhile stories, and maintain a consistent publishing cadence without sacrificing source quality or editorial control.",
    solution: "The system connects market-data ingestion, evidence-backed story leads, source and methodology retention, article drafts, branded artwork, an editorial review desk, and controlled delivery to LinkedIn, Instagram, and Facebook.",
    outcomes: ["One workflow from source data to article and social distribution", "Platform-specific content with human approval before publishing", "A durable library of market intelligence instead of isolated posts"],
    capabilities: ["Next.js", "Postgres", "Data ingestion", "Editorial workflows", "Social publishing", "Asset generation"],
    metrics: ["Three-post daily lineup", "Three social channels", "Human approval gates"],
  },
  {
    slug: "social-paid-campaign-platform",
    category: "Product engineering / Growth systems",
    title: "Social publishing and paid-campaign platform",
    summary: "An operator-facing system for planning content, publishing across channels, building audiences, estimating reach, promoting posts, and creating controlled paid campaigns.",
    challenge: "A hospitality business needed recurring events and offers to move from idea to organic and paid distribution without forcing operators to coordinate separate tools, repetitive setup, and agency handoffs.",
    solution: "A custom administrative product brought the content calendar, publishing status, saved audiences, targeting search, reach estimates, post promotion, campaign creation, budgets, placements, and campaign controls into the business's existing software.",
    outcomes: ["A direct path from content planning to organic and paid distribution", "Reusable audience and targeting workflows for recurring promotions", "Campaign controls and failure visibility inside the operating platform"],
    capabilities: ["React", "Node.js", "Social APIs", "Paid media APIs", "Audience targeting", "Campaign operations"],
    metrics: ["Content-to-campaign workflow", "Audience and reach tooling", "Guardrailed campaign creation"],
  },
  {
...
export const insights = [
  ...
  },
  {
    ...
    cta: { label: "Bring us the stalled project", href: "/book?project=product-engineering" },
  },
] as const;
