  ...
  return (
    <footer className="border-t border-border mt-28">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-12 grid gap-10 md:grid-cols-5">
        <div className="md:col-span-2"><div className="text-sm font-semibold tracking-[0.18em]">ANY AI YOU WANT</div><p className="mt-3 text-muted text-sm max-w-md">Senior strategy, growth marketing, media, and U.S.-based engineering for businesses that need an answer—and the people who can execute it.</p><div className="mt-5 flex flex-wrap gap-3"><Link href="/book" className="inline-flex px-4 py-2 text-sm rounded-md bg-accent text-black font-medium">Start a project →</Link><a href={TIDYCAL_URL} target="_blank" rel="noreferrer" className="px-4 py-2 text-sm rounded-md border border-border hover:bg-surface">Book 15 minutes</a></div></div>
