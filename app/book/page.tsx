...
export const metadata: Metadata = { title: "Start a Project or Book a Focused Consultation", description: "Send a brief or book a focused 15-minute consultation about business strategy, growth marketing, AI, automation, analytics, or software.", alternates: { canonical: "/book" } };

const nextSteps = ["A senior operator or engineer reviews the context", "We identify the most useful next step", "You receive a direct response—not an automated sales sequence"];

export default function BookPage() {
  return (
    <div className="pt-16">
      <section className="max-w-7xl mx-auto px-6 md:px-10 grid lg:grid-cols-12 gap-10 items-end">
        <div className="lg:col-span-8"><div className="label-mono">Start with the problem</div><h1 className="mt-3 text-4xl md:text-6xl font-semibold tracking-tight">Bring the messy version. Leave with a clearer path.</h1><p className="mt-5 text-muted text-lg max-w-3xl">Send enough context for a useful response or choose a 15-minute time. The person reviewing the problem can help shape the answer and stay involved through execution.</p></div>
