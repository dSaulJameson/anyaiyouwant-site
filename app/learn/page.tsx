  ...
  return (
    <div className="pt-16">
      <section className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <h1 className="mt-3 text-4xl md:text-6xl font-semibold tracking-tight max-w-5xl">Technical decisions explained <span className="text-gradient">without the theater.</span></h1>
