  ...
  return (
    <div className="pt-16">
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 mt-24 grid lg:grid-cols-12 gap-12">
        <div className="lg:col-span-7"><div className="label-mono">Technical leadership</div><h2 className="mt-2 text-3xl md:text-4xl font-semibold">Led by D. Saul Jameson.</h2><div className="mt-5 space-y-4 text-muted leading-relaxed"><p>Saul is a machine-learning engineer and technical operator with more than nine years turning messy business problems into production systems. His early work included Bayesian supply-and-demand forecasting for a leading avocado supplier and a recommendation and bidding-optimization engine supporting a national auction business processing more than $300 million annually.</p><p>Across engagements, shipped systems have supported businesses processing more than $1 billion in revenue. The work now spans full-stack products, data platforms, forecasting, recommendation, secure AI, automation, integrations, technical growth systems, and engineering leadership.</p><p>Owned product work includes experiential audio and AI DJ systems alongside payments, media generation, real-time applications, analytics, and production operations. It demonstrates technical range without defining the limits of client work.</p></div></div>
